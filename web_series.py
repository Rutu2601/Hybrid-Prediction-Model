...
def train_and_save_model():
    file_path = "C:/Users/Rituraj Dusane/PycharmProjects/predictionmodel/All_Streaming_Shows.csv"
    ...
    joblib.dump(model, 'C:/Users/Rituraj Dusane/PycharmProjects/knn_model.pkl')
    joblib.dump(vectorizer, 'C:/Users/Rituraj Dusane/PycharmProjects/vectorizer.pkl')
    df.to_csv('C:/Users/Rituraj Dusane/PycharmProjects/cleaned_streaming_data.csv', index=False)

    return "Model trained successfully!"


# Train and save the model if files are missing
if not os.path.exists('C:/Users/Rituraj Dusane/PycharmProjects/knn_model.pkl') or not os.path.exists('C:/Users/Rituraj Dusane/PycharmProjects/vectorizer.pkl'):
    train_and_save_model()


@st.cache_resource
def load_model():
    if os.path.exists('C:/Users/Rituraj Dusane/PycharmProjects/knn_model.pkl') and os.path.exists('C:/Users/Rituraj Dusane/PycharmProjects/vectorizer.pkl'):
        return joblib.load('C:/Users/Rituraj Dusane/PycharmProjects/knn_model.pkl'), joblib.load('C:/Users/Rituraj Dusane/PycharmProjects/vectorizer.pkl')
    else:
...
def recommend_series(user_input, top_n=5):
    try:
        df = pd.read_csv('C:/Users/Rituraj Dusane/PycharmProjects/cleaned_streaming_data.csv')
