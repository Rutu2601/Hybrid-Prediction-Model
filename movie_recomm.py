...
def train_and_save_model():
    file_path = "C:/Users/Rituraj Dusane/PycharmProjects/predictionmodel/movie_recommendation_dataset.csv"
    ...
    joblib.dump(df, 'C:/Users/Rituraj Dusane/PycharmProjects/movie_data.pkl')
    joblib.dump(similarity_matrix, 'C:/Users/Rituraj Dusane/PycharmProjects/similarity_matrix.pkl')
    joblib.dump(tfidf, 'C:/Users/Rituraj Dusane/PycharmProjects/tfidf_vectorizer.pkl')

    return "Model trained successfully."


# Train and save the model if files are missing
if not os.path.exists('C:/Users/Rituraj Dusane/PycharmProjects/movie_data.pkl') or not os.path.exists('C:/Users/Rituraj Dusane/PycharmProjects/similarity_matrix.pkl'):
    train_and_save_model()


@st.cache_resource
def load_model():
    if os.path.exists('C:/Users/Rituraj Dusane/PycharmProjects/movie_data.pkl') and os.path.exists('C:/Users/Rituraj Dusane/PycharmProjects/similarity_matrix.pkl'):
        return joblib.load('C:/Users/Rituraj Dusane/PycharmProjects/movie_data.pkl'), joblib.load('C:/Users/Rituraj Dusane/PycharmProjects/similarity_matrix.pkl')
    else:
